...
function runStart() {
  ...
  function loadingAnimation() { // Goes for 3900 Miliseconds
    let loadStrings = ['trevorjmurphy.github.io loading.',
                    ...
                    'trevorjmurphy.github.io loading...'];
    loadTextForTime(loadStrings[index % 3], 300, "white");
    index++;
    if ( index == 12 ) {
  ...
  setTimeout(function() { // Goes for 1000 ms
    loadTextForTime("trevorjmurphy.github.io loaded!", 1000, "green");
  }, 3900);
  ...
  setTimeout(function() {
    IOPrint("trevorOS v0.1");
    IOPrint("Type HELP for commands");
    IOReady();
  }, 9400);
